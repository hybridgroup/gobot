...
func initTestMCP3208DriverWithStubbedAdaptor(simRead []byte) (*MCP3208Driver, *spiTestAdaptor) {
...
func TestNewMCP3208Driver(t *testing.T) {
	var di interface{} = NewMCP3208Driver(newSpiTestAdaptor([]byte{}))
...
func TestMCP3208Start(t *testing.T) {
	d := NewMCP3208Driver(newSpiTestAdaptor([]byte{}))
	gobottest.Assert(t, d.Start(), nil)
}

func TestMCP3208Halt(t *testing.T) {
	d, _ := initTestMCP3208DriverWithStubbedAdaptor([]byte{})
...
func TestMCP3208Read(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			// arrange
			d, a := initTestMCP3208DriverWithStubbedAdaptor(tc.simRead)
...
func TestMCP3208ReadWithError(t *testing.T) {
	// arrange
	d, a := initTestMCP3208DriverWithStubbedAdaptor([]byte{})
