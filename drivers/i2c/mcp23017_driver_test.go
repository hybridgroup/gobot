...
func TestMCP23017CommandsWriteGPIOErrIODIR(t *testing.T) {
	...
	// assert
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=0): write error")
}
...
func TestMCP23017CommandsWriteGPIOErrOLAT(t *testing.T) {
	...
	err := d.WriteGPIO(7, "A", 0)
	// assert
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=20): write error")
}
...
func TestMCP23017ReadGPIOErr(t *testing.T) {
	...
	// assert
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=0): read error")
}
...
func TestMCP23017SetPullUpErr(t *testing.T) {
	...
	// assert
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=12): write error")
}
...
func TestMCP23017SetGPIOPolarityErr(t *testing.T) {
	...
	// assert
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=2): write error")
}
...
func TestMCP23017_write(t *testing.T) {
	...
	err = d.write(port.IODIR, uint8(7), 0)
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=1): write error")
	...
	err = d.write(port.IODIR, uint8(7), 0)
	assert.Errorf(t, err, "MCP write-read: MCP write-ReadByteData(reg=1): read error")
	a.i2cReadImpl = func(b []byte) (int, error) {
		return len(b), nil
	}
	err = d.write(port.IODIR, uint8(7), 1)
...
func TestMCP23017_read(t *testing.T) {
	...
	assert.Errorf(t, err, "MCP write-ReadByteData(reg=0): read error")
