...
func TestTSL2561DriverStartNotFound(t *testing.T) {
	...
	assert.Errorf(t, d.Start(), "TSL2561 device not found (0x1)")
}
...
func TestTSL2561SetIntegrationTimeError(t *testing.T) {
	...
	assert.Errorf(t, d.SetIntegrationTime(TSL2561IntegrationTime101MS), "write error")
}
...
func TestTSL2561SetGainError(t *testing.T) {
	...
	assert.Errorf(t, d.SetGain(TSL2561Gain16X), "write error")
}
