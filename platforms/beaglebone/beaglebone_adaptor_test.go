...
func TestPWM(t *testing.T) {
	...
	assert.Errorf(t, a.PwmWrite("P9_99", 175), "'P9_99' is not a valid id for a PWM pin")
...
func TestAnalog(t *testing.T) {
	...
	assert.Errorf(t, err, "Not a valid analog pin")
...
func TestDigitalIO(t *testing.T) {
	...
	assert.Errorf(t, err, " : /sys/class/leds/beaglebone:green:usr10101/brightness: no such file")

	_ = a.DigitalWrite("P9_12", 1)
	assert.Equal(t, "1", fs.Files["/sys/class/gpio/gpio60/value"].Contents)

	assert.Errorf(t, a.DigitalWrite("P9_99", 1), "'P9_99' is not a valid id for a digital pin")
